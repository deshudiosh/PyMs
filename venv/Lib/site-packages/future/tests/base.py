...
class VerboseCalledProcessError(CalledProcessError):
    ...
    script output) for diagnosing test.py failures etc.
    """
...
class CodeHandler(unittest.TestCase):
    """
    Handy mixin for test.py classes for writing / reading / futurizing /
    running .py files in the test.py suite.
    """
    def setUp(self):
        """
    ...
    def compare(self, output, expected, ignore_imports=True):
        ...
        exception so the test.py fails. Ignores any trailing whitespace like
        blank lines.
    ...
    def convert_check(self, before, expected, stages=(1, 2), all_imports=False,
        ...
        needn't appear repeatedly in the test.py code.
...
skip26 = unittest.skipIf(PY26, "this test.py is known to fail on Py2.6")
...
def assertRegex(self, text, expected_regex, msg=None):
    """Fail the test.py unless the text matches the regular expression."""
