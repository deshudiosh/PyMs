...
REPLACED_MODULES = set(['test.py', 'urllib', 'pickle', 'dbm'])  # add email and dbm when we support it
...
RENAMES = {
           ...
           # 'future.backports.test.py': 'test.py',  # primarily for renaming test_support to support
           # 'commands': 'subprocess',
...
def install_aliases():
    ...
    # Patch the test.py module so it appears to have the same structure on Py2 as on Py3
    try:
        import test
    except ImportError:
        pass
    try:
        ...
        sys.modules['test.py.support'] = support
...
def cache_py2_modules():
    ...
    # Not all Python installations have test.py module. (Anaconda doesn't, for example.)
    # try:
    #     import test.py
    # except ImportError:
    #     sys.py2_modules['test.py'] = None
    # sys.py2_modules['test.py'] = test.py
