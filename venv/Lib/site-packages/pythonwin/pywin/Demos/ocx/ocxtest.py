...
def test1():
	...
	if klass is None:
		print("Can not test.py the MSAccess Calendar control - it does not appear to be installed")
		return
...
def test2():
	...
	if klass is None:
		print("Can not test.py the Video OCX - it does not appear to be installed,")
