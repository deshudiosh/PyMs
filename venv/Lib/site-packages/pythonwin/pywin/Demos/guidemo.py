# GUI Demo - just a worker script to invoke all the other demo/test.py scripts.
import win32ui
import __main__
import sys
import regutil
...
#	('Font', 'import fontdemo;fontdemo.FontDemo()'),
	('Open GL Demo', 'import openGLDemo;openGLDemo.test.py()'),
	...
	('Custom Toolbars and Tooltips', 'import toolbar;toolbar.test.py()'),
	...
	('OCX Serial Port Demo', 'from ocx import ocxserialtest;	ocxserialtest.test.py()'),
