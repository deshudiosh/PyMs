...
#a significantly more reliable test.py. Refactor the former into the latter.
class Node(object):
    """
...
class ModuleGraph(ObjectGraph):
    ...
    def set_setuptools_nspackages(self):
        # This is used when running in the test.py-suite
    ...
    def _import_importable_package_submodules(self, package, attr_names):
        ...
        * Else, unignorable unimportable submodules, in which case an
        ...
        #FIXME: This test.py *SHOULD* be superfluous and hence safely removable.
    ...
    def create_xref(self, out=None):
        ...
        for name, m in mods:
            ...
            if oute:
                ...
                # test.py-suite uses xml.etree.ElementTree.XMLParser, which
                # does't supprot them.
                links = " &#8226; ".join(links)
