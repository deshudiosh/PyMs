...
def skip(reason):
    """
    Unconditionally skip the currently decorated test.py with the passed reason.
    ...
    * `pytest.mark.skip()`, intended to be called only indirectly as a
    ...
    ----------
    reason : str
        Human-readable message justifying the skipping of this test.py.
    """
...
def importorskip(modname, minversion=None):
    """
    This decorator skips the currently decorated test.py if the module with the
    ...
    ----------
    modname : str
        Fully-qualified name of the module required by this test.py.
    minversion : str
        Optional minimum version of this module as a string (e.g., `3.14.15`)
        required by this test.py _or_ `None` if any module version is acceptable.
        Defaults to `None`.
