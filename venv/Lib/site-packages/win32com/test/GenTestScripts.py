...
#       tlb = apply(pythoncom.LoadRegTypeLib, loadArgs)
    ...
    f.close()
    print("compiling -", end=' ')
    fullModName = "win32com.test.py.%s.%s" % (genDir, fname)
...
def GenerateAll():
    for args in genList:
        try:
            ...
            print("** Could not generate test.py code for ", args[0])

def CleanAll():
    print("Cleaning generated test.py scripts...")
    ...
    try:
        ...
        print("Could not delete test.py directory -", details)
