...
importMsg = "**** PyCOMTest is not installed ***\n  PyCOMTest is a Python test.py specific COM client and server.\n  It is likely this server is not installed on this machine\n  To install the server, you must get the win32com sources\n  and build it using MS Visual C++"

error = Exception

# This test.py uses a Python implemented COM server - ensure correctly registered.
...
class RandomEventHandler:
    ...
    def OnFireWithNamedParams(self, no, a_bool, out1, out2):
        # This test.py exists mainly to help with an old bug, where named
...
def TestCommon(o, is_generated):
    ...
    # We want to explicitly test.py > 32 bits.  py3k has no 'maxint' and
...
def TestGenerated():
    ...
    TestEvents(o, handler)
    progress("Finished generated .py test.py.")
...
def _TestPyVariant(o, is_generated, val, checker = None):
    ...
    # Handle our safe-array test.py - if the passed value is a list of variants,
...
def TestVTable(clsctx=pythoncom.CLSCTX_ALL):
    ...
    TestLocalVTable(ob)
    # Now test.py it via vtable - use some C++ code to help here as Python can't do it directly yet.
...
class Tester(win32com.test.util.TestCase):
    ...
    def testMultiQueryInterface(self):
        ...
        # E_NOINTERFACE. Set the upper range of the following test.py to 2 to
        # pass this test.py, i.e. TestQueryInterface(1,2)
