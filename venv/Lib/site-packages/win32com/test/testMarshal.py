...
When this test.py is run in "free threaded" mode (at this stage, you must
...
class ThreadInterpCase(InterpCase):
    ...
    def _doTestInThread(self, interp):
        ...
        #print "The test.py thread id is %d, Python.Interpreter's thread ID is %d" % (myThread, interp.Eval("win32api.GetCurrentThreadId()"))
