# The purpose of this test.py is to ensure that the gateways objects
# do the right thing WRT COM rules about object identity etc.

# Also includes a basic test.py that we support inheritance correctly in
# gateway interfaces.

# For our test.py, we create an object of type IID_IPersistStorage
...
def TestGatewayInheritance():
    ...
    # As the object is correctly discarded, it doesnt affect this test.py.
