# Test MSOffice
#
# Main purpose of test.py is to ensure that Dynamic COM objects
# work as expected.
...
def TestWord():
    ...
    try:
        ...
        print("Starting Word 8 for dynamic test.py")
        word = win32com.client.dynamic.Dispatch("Word.Application")
        TestWord8(word)

        word = None
        # Now we will test.py Dispatch without the new "lazy" capabilities
        print("Starting Word 8 for non-lazy dynamic test.py")
        ...
        print("Starting Word 7 for dynamic test.py")
        word = win32com.client.Dispatch("Word.Basic")
        TestWord7(word)

    print("Starting MSWord for generated test.py")
    from win32com.client import gencache
...
def TestWord8OldStyle():
    try:
        ...
        print("Can not do old style test.py")
...
def TestAll():
    ...
    print("Starting Excel for Dynamic test.py...")
    xl = win32com.client.dynamic.Dispatch("Excel.Application")
    TextExcel(xl)

    try:
        print("Starting Excel 8 for generated excel8.py test.py...")
    ...
    try:
        ...
        print("Starting Excel 95 for makepy test.py...")
        TextExcel(xl)
    except ImportError:
