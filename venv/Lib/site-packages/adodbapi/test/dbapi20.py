#!/usr/bin/env python
''' Python DB API 2.0 driver compliance unit test.py suite.
 ...
 "Now we have booze and barflies entering the discussion, plus rumours of
  ...
  this is turning out to be a thoroughly unwholesome unit test.py."
...
# Add a literal string to the format insertion test.py to catch trivial re-format algorithms

# Revision 1.13  2013/05/08 14:31:50  kf7xm
# Quick switch to Turn off IDEMPOTENT_CLOSE test.py. Also: Silence teardown failure
...
# Add test.py for DB API 2.0 optional extension, where database exceptions
...
# Implement suggestions and code from Henrik Eklund - test.py that cursor.arraysize
# defaults to 1 & generic cursor.callproc test.py added
#
...
# - Reversed the polarity of buggy test.py in test_description
...
class DatabaseAPI20Test(unittest.TestCase):
    ''' Test a database self.driver for DB API 2.0 compatibility.
        ...
        test.py case to ensure compiliance with the DB-API. It is
        expected that this TestCase may be expanded in the future
        if ambiguities or edge conditions are discovered.

        The 'Optional Extensions' are not yet being tested.

        self.drivers should subclass this test.py, overriding setUp, tearDown,
    ...
    def tearDown(self):
        ''' self.drivers should override this method to perform required cleanup
            if any is necessary, such as deleting the test.py database.
    ...
    def test_ExceptionsAsConnectionAttributes(self):
        ...
        # driver author who is using this test.py suite, so it is enabled
        # by default.
        con = self._connect()
        drv = self.driver
    ...
    def test_close(self):
        ...
        #!!! reasonable persons differ about the usefulness of this test.py and this feature !!!
    ...
    def test_nextset(self):
        raise NotImplementedError('Drivers need to override this test.py')
    ...
    def test_setoutputsize_basic(self):
        # Basic test.py is to make sure setoutputsize doesn't blow up
        con = self._connect()
        try:
            cur = con.cursor()
    ...
    def test_setoutputsize(self):
        # Real test.py for setoutputsize is driver dependant
        raise NotImplementedError('Driver needed to override this test.py')
