...
keyname='Pywin32 test.py transacted registry functions'
subkeyname='test.py transacted subkey'
classname='Transacted Class'

trans=win32transaction.CreateTransaction(Description='test.py RegCreateKeyTransacted')
...
## test.py transacted delete
del_trans=win32transaction.CreateTransaction(Description='test.py RegDeleteKeyTransacted')
