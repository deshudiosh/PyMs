...
sub testcollection
   if test.py.collection.Item(0) <> 1 then
     test.py.fail("Index 0 was wrong")
   end if
   if test.py.collection.Item(1) <> "Two" then
     test.py.fail("Index 1 was wrong")
   end if
   if test.py.collection.Item(2) <> 3 then
     test.py.fail("Index 2 was wrong")
   end if
   num = 0
   ...
   next
   if num <> 3 then
     test.py.fail("Collection didn't have 3 items")
   end if
end sub
"""
PyScript = """\
...
#   test.py.collection[1] = "New one"
   ...
   for item in test.py.collection:
     got.append(item)
   if got != [1, "Two", 3]:
     test.py.fail("Didn't get the collection")
   pass
"""
