...
class DirectSoundTest(unittest.TestCase):
    ...
    def testPlay(self):
        ...
        # look for the test.py file in various places
        candidates = [
            os.path.dirname(__file__),
            os.path.dirname(sys.argv[0]),
            # relative to 'testall.py' in the win32com test.py suite.
            os.path.join(os.path.dirname(sys.argv[0]),
                         '../../win32comext/directsound/test.py'),
            '.',
        ]
        for candidate in candidates:
            ...
            raise TestSkipped("Can't find test.py .wav file to play")
